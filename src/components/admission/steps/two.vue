    ...
    <form @submit.prevent="submit1">
      ...
      <div v-show="!checkParent">
        ...
        <div id="container">
          ...
          <!-- email of father -->
          <v-layout row v-if="!hideFields.has('father e-mail')">
          ...
          <v-layout row v-if="!hideFields.has('father income')">
          ...
          <v-layout row wrap v-if="!hideFields.has('mother lastname')">
            ...
            <v-flex xs4>
              <input type="text" place holder="Last Name" name="mother lastname" v-validate="'required|alpha_spaces'" data-vv-delay="300"
...
<script>
  export default {
    ...
    mounted() {
      ...
      // displayTextBox() {
      //     this.$emit('input','parent'==true)
      //     return this.form.ffname;
      //   }
    },
    watch: {
      menu(val) {
